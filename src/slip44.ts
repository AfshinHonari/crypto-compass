...
// Enhanced fallback list with token standards and more networks
export const FALLBACK_SLIP44: Slip44Entry[] = [
  { 
    coinType: 0, 
    name: "bitcoin", 
    symbol: "BTC", 
    aliases: ["btc", "bitcoin mainnet", "bitcoin mainnet", "bitcoin network", "bitcoin blockchain", "bitcoin protocol"],
  ...
  { 
    ...
    name: "ethereum", 
    symbol: "ETH", 
    aliases: ["eth", "ethereum mainnet", "ethereum network", "ethereum blockchain", "ethereum protocol"],
  ...
  { 
    ...
    symbol: "ETC", 
    aliases: ["etc", "ethereum classic", "ethereum classic network", "etc network", "classic"],
  ...
  { 
    ...
    name: "tron", 
    symbol: "TRX", 
    aliases: ["trx", "tron mainnet", "tron network", "tron blockchain", "tron protocol", "tronix"],
  ...
  { 
    ...
    name: "polygon", 
    symbol: "MATIC", 
    aliases: ["matic", "polygon pos", "polygon mainnet", "polygon network", "polygon blockchain", "matic network"],
    tokenStandards: ["ERC-20", "ERC-721", "ERC-1155"],
    networkType: "mainnet",
    decimals: 18
  },
  { 
    ...
    name: "solana", 
    symbol: "SOL", 
    aliases: ["sol", "solana mainnet", "solana network", "solana blockchain", "solana protocol"],
  ...
  { 
    ...
    name: "cosmos", 
    symbol: "ATOM", 
    aliases: ["atom", "cosmos hub", "cosmos network", "cosmos blockchain", "cosmos protocol"],
  ...
  { 
    ...
    name: "tezos", 
    symbol: "XTZ", 
    aliases: ["xtz", "tezos mainnet", "tezos network", "tezos blockchain", "tezos protocol"],
  ...
  { 
    coinType: 5, 
    name: "goerli", 
    aliases: ["goerli testnet", "ethereum goerli", "goerli", "goerli network", "ethereum testnet"],
    tokenStandards: ["ERC-20", "ERC-721", "ERC-1155"],
    networkType: "testnet",
    decimals: 18
  },
  { 
    coinType: 11155111, 
    name: "sepolia", 
    aliases: ["sepolia testnet", "ethereum sepolia", "sepolia", "sepolia network"],
    tokenStandards: ["ERC-20", "ERC-721", "ERC-1155"],
    networkType: "testnet",
    decimals: 18
  },
  ...
  { 
    ...
    symbol: "BNB", 
    aliases: ["bsc", "binance smart chain", "bnb smart chain", "binance chain", "bsc network", "binance blockchain", "bnb chain"],
  ...
  { 
    ...
    aliases: ["bsc testnet", "binance smart chain testnet", "bsc test", "binance testnet"],
    tokenStandards: ["BEP-20", "BEP-721"],
    networkType: "testnet",
    decimals: 18
  },
  { 
    ...
    name: "fantom", 
    symbol: "FTM", 
    aliases: ["ftm", "fantom opera", "fantom network", "fantom blockchain", "fantom protocol"],
    tokenStandards: ["ERC-20", "ERC-721", "ERC-1155"],
    networkType: "mainnet",
    decimals: 18
  },
  ...
  { 
    ...
    name: "avalanche", 
    symbol: "AVAX", 
    aliases: ["avax", "avalanche c-chain", "avalanche network", "avalanche blockchain", "avalanche protocol", "avax network"],
    tokenStandards: ["ERC-20", "ERC-721", "ERC-1155"],
    networkType: "mainnet",
    decimals: 18
  },
  { 
    ...
    aliases: ["avax testnet", "avalanche testnet", "avalanche test", "avax test"],
    tokenStandards: ["ERC-20", "ERC-721", "ERC-1155"],
    networkType: "testnet",
    decimals: 18
  },
  ...
  { 
    ...
    name: "sonic", 
    symbol: "SONIC", 
    aliases: ["sonic mainnet", "sonic network", "sonic blockchain", "sonic protocol"],
  ...
  { 
    ...
    name: "cardano", 
    symbol: "ADA", 
    aliases: ["ada", "cardano mainnet", "cardano network", "cardano blockchain", "cardano protocol"],
  ...
  { 
    ...
    name: "ripple", 
    symbol: "XRP", 
    aliases: ["xrp", "ripple mainnet", "ripple network", "ripple blockchain", "ripple protocol"],
  ...
  { 
    ...
    name: "stellar", 
    symbol: "XLM", 
    aliases: ["xlm", "stellar mainnet", "stellar network", "stellar blockchain", "stellar protocol"],
  ...
  { 
    ...
    name: "polkadot", 
    symbol: "DOT", 
    aliases: ["dot", "polkadot mainnet", "polkadot network", "polkadot blockchain", "polkadot protocol"],
  ...
  { 
    ...
    name: "chainlink", 
    symbol: "LINK", 
    aliases: ["link", "chainlink mainnet", "chainlink network", "chainlink blockchain"],
  ...
  { 
    ...
    name: "uniswap", 
    symbol: "UNI", 
    aliases: ["uni", "uniswap mainnet", "uniswap network", "uniswap blockchain"],
    tokenStandards: ["ERC-20"],
    networkType: "mainnet",
    decimals: 18
  },
  ...
  { 
    ...
    name: "compound", 
    symbol: "COMP", 
    aliases: ["comp", "compound mainnet", "compound network", "compound blockchain"],
    tokenStandards: ["ERC-20"],
    networkType: "mainnet",
    decimals: 18
  },
  ...
  { 
    ...
    name: "balancer", 
    symbol: "BAL", 
    aliases: ["bal", "balancer mainnet", "balancer network", "balancer blockchain"],
    tokenStandards: ["ERC-20"],
    networkType: "mainnet",
    decimals: 18
  },
  { 
    ...
    name: "synthetix", 
    symbol: "SNX", 
    aliases: ["snx", "synthetix mainnet", "synthetix network", "synthetix blockchain"],
    tokenStandards: ["ERC-20"],
    networkType: "mainnet",
    decimals: 18
  },
...
export function matchEntries(entries: Slip44Entry[], query: string, showTestnets: boolean = true): Slip44Entry[] {
  // Filter testnets based on preference
  const filteredEntries = showTestnets ? entries : entries.filter(e => e.networkType !== "testnet");
  ...
  const exactMatches = filteredEntries.filter((e) => 
  ...
  // Partial matches
  const partialMatches = filteredEntries.filter((e) => 
  ...
  if (q.includes("erc") || q.includes("trc") || q.includes("bep") || q.includes("spl") || q.includes("cw") || q.includes("fa")) {
    // Remove dashes for token standard comparison
    const standard = q.toLowerCase().replace(/-/g, '');
    return filteredEntries
      .filter((e) => e.tokenStandards?.some(ts => ts.toLowerCase().replace(/-/g, '').includes(standard)))
      .sort((a, b) => {
        if (a.networkType === "mainnet" && b.networkType !== "mainnet") return -1;
        if (a.networkType !== "mainnet" && b.networkType === "mainnet") return 1;
        return a.coinType - b.coinType;
  ...
  return filteredEntries
    ...
    .sort((a, b) => {
      ...
      if (a.e.networkType === "mainnet" && b.e.networkType !== "mainnet") return -1;
      if (a.e.networkType !== "mainnet" && b.e.networkType === "mainnet") return 1;
      // Then by score
...
function scoreName(entry: Slip44Entry, words: string[]): number {
  ...
  for (const w of words) {
    ...
    if (entry.aliases?.some(alias => alias.toLowerCase().includes(w))) score += 5;
    ...
    if (entry.tokenStandards?.some(ts => ts.toLowerCase().replace(/-/g, '').includes(w.replace(/-/g, '')))) score += 4;
    
    // Bonus for network type matches
    if (entry.networkType && entry.networkType.toLowerCase().includes(w)) score += 2;
  }
  return score;
}
...
export function toDecimalString(amount: string, decimals: number): string {
  console.log(`toDecimalString called with: amount="${amount}", decimals=${decimals}`);
  ...
  try {
    ...
    console.log(`Split parts: integer="${integerPart}", decimal="${decimalPart}"`);
    ...
    console.log(`After padding: integer="${integerPart}", decimal="${decimalPart}"`);
...
export function fromDecimal(decimalAmount: string, decimals: number): string {
  try {
    ...
    while (cleanDecimal.length > 1 && cleanDecimal[cleanDecimal.length - 1] === '0') {
...
export async function getSlip44Entries(): Promise<Slip44Entry[]> {
  const now = Date.now();
  if (cachedEntries && now - fetchedAtMs < CACHE_TTL_MS) {
    console.log("Returning cached entries:", cachedEntries.length);
    return cachedEntries;
  }

  // Always start with fallback data
  let finalEntries = [...FALLBACK_SLIP44];
  console.log("Starting with fallback entries:", finalEntries.length);

  try {
    console.log("Fetching slip44 entries from GitHub...");
    
    // Try multiple URLs in case one fails
    const urls = [
      "https://raw.githubusercontent.com/satoshilabs/slips/master/slip-0044.md",
      "https://raw.githubusercontent.com/satoshilabs/slips/main/slip-0044.md"
    ];
    ...
    for (const url of urls) {
      try {
        ...
        const res = await fetch(url, { 
          ...
          headers: {
            'Accept': 'text/plain',
            'User-Agent': 'Raycast-SLIP44-Extension/1.0'
          }
        });
        ...
        if (res.ok) {
          ...
          console.log("Failed to fetch from:", url, res.status);
        }
      } catch (fetchError) {
    ...
    console.log("Fetched markdown, length:", text.length);
    console.log("First 500 characters:", text.substring(0, 500));
    
    const parsed = parseSlip44Markdown(text);
    console.log("Parsed entries from markdown:", parsed.length);
    
    if (parsed.length > 0) {
      console.log("Sample parsed entry:", parsed[0]);
      // Merge with fallback data
      finalEntries = mergeEntries(FALLBACK_SLIP44, parsed);
      console.log("Successfully merged entries:", finalEntries.length);
    } else {
      console.log("No entries parsed from markdown, keeping fallback data");
    }
  } catch (error) {
    console.error("Error fetching slip44 entries:", error);
    console.log("Using fallback data only");
  }
  
  // Always cache and return something
  cachedEntries = finalEntries;
  fetchedAtMs = now;
  console.log("Final result:", finalEntries.length, "entries");
  return finalEntries;
}

function mergeEntries(base: Slip44Entry[], incoming: Slip44Entry[]): Slip44Entry[] {
  const byId = new Map<number, Slip44Entry>();
  for (const e of base) byId.set(e.coinType, e);
  for (const e of incoming) byId.set(e.coinType, { ...byId.get(e.coinType), ...e });
  return Array.from(byId.values()).sort((a, b) => a.coinType - b.coinType);
}

// Parse a subset of the markdown table in SLIP-0044 into entries
function parseSlip44Markdown(md: string): Slip44Entry[] {
  console.log("Parsing markdown, length:", md.length);
  
  const lines = md.split(/\r?\n/);
  const entries: Slip44Entry[] = [];
  
  // Look for any line that contains a pipe and numbers
  for (let i = 0; i < lines.length; i++) {
    const line = lines[i].trim();
    
    // Skip empty lines and headers
    if (!line || line.startsWith('#') || line.includes('Coin type')) {
      continue;
    }
    
    // Look for lines with pipes that might contain coin data
    if (line.includes('|') && /\d+/.test(line)) {
      ...
      try {
        ...
        if (parts.length >= 2) {
          // Try to find a number (coin type) in the first few parts
          let coinType = -1;
          let name = '';
          let symbol = '';
          ...
          for (let j = 0; j < Math.min(parts.length, 4); j++) {
            const part = parts[j];
            if (/^\d+$/.test(part) && coinType === -1) {
              coinType = parseInt(part);
            } else if (/^[A-Z]{2,5}$/.test(part) && !symbol) {
              symbol = part;
            } else if (part.length > 3 && !name && !/^\d+/.test(part)) {
              name = part;
            }
          }
          
          if (coinType !== -1 && name) {
            console.log(`Found entry: ${coinType} - ${name} (${symbol})`);
            
            const entry: Slip44Entry = {
              coinType,
            ...
            // Add symbol as alias
            if (symbol) {
              entry.aliases!.push(symbol.toLowerCase());
            }
            
            // Add testnet detection
            if (name.toLowerCase().includes("test")) {
              entry.networkType = "testnet";
            }
...
// Helper function to get default decimals for common networks
function getDefaultDecimals(name: string, symbol: string): number | undefined {
